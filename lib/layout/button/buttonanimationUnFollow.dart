...
class buttonanimationUnFollow extends StatefulWidget {
  String? uIdMine;
   SocialUserModel? getuserModelFriend;
  
  buttonanimationUnFollow({Key? key, this.uIdMine, this.getuserModelFriend}) : super(key: key);
 


  @override
  _buttonanimationUnFollowState createState() => _buttonanimationUnFollowState();
}

class _buttonanimationUnFollowState extends State<buttonanimationUnFollow> {
