              ...
              defaultTextButton(
                ...
                function: () {
                  if (SocialCubit.get(context).paths != null) {
                    print('-------------=============ĐÃ THÊM ẢNH TRONG GRID VIEW CREATE POST=========------');
                    // List<PostModelSub>? hinhs = [];
                    // List<PostModelSub>? hinhs = [
                    //   PostModelSub(
                    //             name:'name',
                    //             uId: 'uId',
                    ...
                    // SocialCubit.get(context).createPostSub(
                    ...
                    //   name: socialUserModel!.name,
                    //   postText: textController.text,
                    //   // listMedia: SocialCubit.get(context).paths!,
                    //   subPost: SocialCubit.get(context).paths!,
                    //   // postImage1: SocialCubit.get(context).postImage!.path,
                    //   date: getDate(),
                    //   time: DateFormat.jm().format(DateTime.now()),
                    // );
                  }
                        ...
                        children: <Widget>[
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              SizedBox(width: 10,),
                              const Text('Gỡ tất cả hình ảnh/video',style: TextStyle(color: Colors.blue),),
                            ],
                          ),
                           onPressed: (){                        
                       ...
                       Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          GridView.builder(
                              ...
                              itemCount:
                                  SocialCubit.get(context).paths!.length,
                              shrinkWrap: true,
                              gridDelegate:
                                     ...
                                     Container(
                                       ...
                                       (
                                        (SocialCubit.get(context)
                                               .paths![index].path!.split('.').last == 'JPG') ||
                                               (SocialCubit.get(context)
                                               .paths![index].path!.split('.').last == 'PNG') ||
                                        (SocialCubit.get(context)
                                               .paths![index].path!.split('.').last == 'jpg') || 
                                        (SocialCubit.get(context)
                                               .paths![index].path!.split('.').last == 'png')) ?
