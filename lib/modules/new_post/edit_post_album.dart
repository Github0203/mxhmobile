...
import 'package:socialapp/modules/new_post/edit_post_sub_album.dart';
...
class EditPostScreenAlbum extends StatefulWidget {
  String? postId;
  ...
  @override
  State<EditPostScreenAlbum> createState() => _EditPostScreenAlbumState();
}

class _EditPostScreenAlbumState extends State<EditPostScreenAlbum> {
  var textControllerNameAlbum = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SocialCubit, SocialStates>(
      ...
      builder: (context, state) {
        ...
        textControllerDes.text = postModel!.des!;
        postModel!.nameAlbum! == '' ?
        textControllerNameAlbum.text = '' :
        textControllerNameAlbum.text = postModel!.nameAlbum!;
            }
            else{
          ...
          appBar: AppBar(
            ...
            actions: [
                TextButton(onPressed: () {
                      ...
                      .saveEditPostandSubPostAlbum(postModel!.postId);
                },
                child: Text('UPDATE'))
            ],
            leading: IconButton(
    ...
    actions: [
      OutlinedButton(
          onPressed: (){
            SocialCubit.get(context).ResetPostandSubPostAlbum(postModel!.postId, context);
            // Navigator.pop(context);
            // Navigator.pop(context);
            // Navigator.pop(context);
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: TextFormField(
                                onChanged: (value) {
                                  textControllerNameAlbum.text = value;
                                  SocialCubit.get(context).textNameAlbumTemp = value;
                                },
                                controller:
                                    TextEditingController(text: SocialCubit.get(context).textNameAlbum),
                              ...
                              Expanded(
                                child: TextFormField(
                                 onChanged: (value) {
                                  ...
                                  SocialCubit.get(context).textDesPostTemp = value;
                                },
                                controller:
                                        ...
                                        children: [
                                          GridView.builder(
                                              ...
                                              itemBuilder: (BuildContext context,
                                                ...
                                                return Column(
                                                  children: <Widget>[
                                                    Text(postmodelSub[index].tagsTemp.toString()),
                                                    Container(
                                                      width: 100,
                                                      height: 100,
                                                      color: Colors.green,
                              ...
                              children: [
                                Expanded(
                                  child: TextButton(
                                    ...
                                    // },
                                    onPressed: () {
                                      SocialCubit.get(context).pickFilesEditAlbum(
                                          // widget.postId,
                                          // socialUserModel.name,
