...
import 'package:socialapp/shared/network/UrlTypeHelper';
import 'package:socialapp/layout/video/video_player.dart';
import 'package:socialapp/shared/tags/edittagsSubpostwhencreateAlbum.dart';


class EditSubPostAlbumScreenWhenCreate extends StatefulWidget {
  
  int? id;
  List? gettags;
  List? gettagsFromCreateTags;

  EditSubPostAlbumScreenWhenCreate({
    Key? key,
    this.id,
  ...
  @override
  State<EditSubPostAlbumScreenWhenCreate> createState() => _EditSubPostAlbumScreenWhenCreateState();
}

class _EditSubPostAlbumScreenWhenCreateState extends State<EditSubPostAlbumScreenWhenCreate> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<SocialCubit, SocialStates>(
      ...
      builder: (context, state) {
        ...
        widget.gettagsFromCreateTags == null ? widget.gettagsFromCreateTags = [] : '';
        return 
        Scaffold(
                  ...
                  children: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: SizedBox(
                        ...
                        child: edittagsSubpostwhencreateAlbum()),
                  ...
                  Stack(
                   ...
                   Row(
                    ...
                    TextButton(onPressed: () {
                      print('-----------------widget.gettagsFromCreateTags---------------');
                      print(widget.gettagsFromCreateTags);
                      // SocialCubit.get(context).valueTagsSubwhenCreate = SocialCubit.get(context).valueTagsSubwhenCreateTemp;
                      SocialCubit.get(context).editItemeditSubpostAlbumWhenCreate(widget.id, textControllerDes.text, widget.gettagsFromCreateTags);
