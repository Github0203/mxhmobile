...
class EditSubPostScreen extends StatefulWidget {
  String? uId;
  String? postId;
  String? subpostId;
  int? id;
  ...
  @override
  State<EditSubPostScreen> createState() => _EditSubPostScreenState();
}

class _EditSubPostScreenState extends State<EditSubPostScreen> {
                  ...
                  Container(),
                   ...
                   Row(
                    ...
                    TextButton(onPressed: () {
                      ...
                      SocialCubit.get(context).editItemeditSubpost(widget.id, textControllerDes.text, widget.postId!, widget.subpostId!);
