...
import 'package:socialapp/modules/userLike/UserLikeAlbumSub.dart';

class CommentsScreenSubAlbum extends StatelessWidget {
  ...
  CommentsScreenSubAlbum({this.postId,  this.likes, this.postUid, this.postIdSub});

  @override
  Widget build(BuildContext context) {
    String? postId = this.postId;
    String? postIdSub = this.postIdSub;
    return Builder(
      builder: (context) {
        SocialCubit.get(context).getCommentsSubAlbum(postId, postIdSub);
                                    ...
                                    return AlertDialog(
                                      ...
                                      width: setWidth * 0.7,
                                        child: Column(
                                          ...
                                          children: [
                                            UserLikeAlbumSub(postId!, postIdSub)
                                          ],
                                        ),
                                      ),
                                    );
