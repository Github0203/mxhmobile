...
class UserLikeAlbumSub extends StatelessWidget {
  String? idPost;
  String? idPostSub;
  UserLikeAlbumSub(this.idPost, this.idPostSub);
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
      builder: (context) {
        SocialCubit.get(context).getDetailUserLikePostAlbumSub(idPost!, idPostSub!);
   ...
   InkWell(
        onTap: (){
          navigateTo(context, ProfileScreenFriend (  
           userId: SocialCubit.get(context).socialUserModel!.uId.toString(),));
        },
     child: Row(
