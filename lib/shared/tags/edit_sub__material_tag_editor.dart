...
class Edit_Sub_Material_tag_editor extends StatefulWidget {
  Edit_Sub_Material_tag_editor({Key? key, this.gettags}) : super(key: key);

  final List? gettags;

  @override
  _Edit_Sub_Material_tag_editorState createState() => _Edit_Sub_Material_tag_editorState();
}

class _Edit_Sub_Material_tag_editorState extends State<Edit_Sub_Material_tag_editor> {
  List<String>? _values = [];
                ...
                TagEditor(
                  ...
                  onSubmitted: (outstandingValue) {
                    if(outstandingValue != ''){
                      ...
                      SocialCubit.get(context).valueTagsSub = widget.gettags!;
                    });
                    }
                    print(SocialCubit.get(context).valueTagsSub);
                  },
