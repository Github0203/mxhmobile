...
class Material_tag_editor extends StatefulWidget {
  Material_tag_editor({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _Material_tag_editorState createState() => _Material_tag_editorState();
}

class _Material_tag_editorState extends State<Material_tag_editor> {
  List<String> _values = [];
